...
from utils.pointcloud import random_sample_rotation, random_sample_rotation_v2, get_transform_from_rotation_translation
from utils.registration import get_correspondences


class ThreeDMatchPairDataset(data.Dataset):
    def __init__(
        self,
        dataset_root,
        subset,
