...
from glorn.engine import Logger
from glorn.modules.registration import weighted_procrustes
from glorn.utils.summary_board import SummaryBoard
from glorn.utils.open3d import registration_with_ransac_from_correspondences
from glorn.utils.registration import evaluate_sparse_correspondences, evaluate_correspondences, compute_registration_error
from utils.threedmatch import get_num_fragments, get_scene_abbr, get_gt_logs_and_infos, compute_transform_error, write_log_file
...
def eval_one_epoch(args, cfg, logger, num_corr):
    ...
    for scene_root in scene_roots:
        ...
        for file_name in file_names:
            ...
            if num_corr is not None and corr_scores.shape[0] > num_corr:
...
def main(benchmark, num_corr):
    ...
    eval_one_epoch(args, cfg, logger, num_corr)
